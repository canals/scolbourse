...
class RapportControleur extends AbstractControleur {
	...
	public function generer_facture_achat_particulier(){
		...
		if($oid!=0) {
			...
			if ($dossier!=null){ 
				...
				if ($regle!=null){
					...
					$pdf->SetXY(163,$placementvertical);
					$pdf->SetFont('Arial','B',9);
					$pdf->Cell(10,0,'Restant à payer : '. ($montantapayer-$montantdejapaye) .' €',0,0,'C',0);
				}else{
					$pdf->SetFont('Arial','',8);
					$placementvertical=$placementvertical+8;
					$pdf->SetXY(10,$placementvertical);
				...
				$pdf->Output('./rapports/particuliers/facture_achat_particulier_famille_'.$famille->getAttr('nom_famille').'.pdf','F');
			}
		}
		...
		$html .= "<div align='center'>";
		if ($dossier!=null){
			$html .= "<a href='/ScolBoursePHP/rapports/particuliers/facture_achat_particulier_famille_".$famille->getAttr('nom_famille').".pdf' target='_blank' onclick='window.location.reload(); return true;'>";
			$html .= "<font color='#E35F06'>Ouvrir</font></a>&nbsp;&nbsp;";
		}
		$html .= "<a href='' onclick='window.location.reload(); return true;'>";
		$html .= "<font color='#131313'>Fermer</font>";
	...
	public function generer_retour_invendus_particulier(){
		...
		if($oid!=0) {
			...
			$pdf->Output('./rapports/particuliers/retour_invendus_famille_'.$famille->getAttr('nom_famille').'.pdf','F');
		}
		$html = "";	
		$html .= "<div style='width:200; overflow:auto;'>";
		$html .= "<h3>Resultat</h3><br/>";$html .= "<table align='left'>";
		...
		$html .= "<div align='center'>";
		if ($dossier!=null){
			$html .= "<a href='/ScolBoursePHP/rapports/particuliers/retour_invendus_famille_".$famille->getAttr('nom_famille').".pdf' target='_blank' onclick='window.location.reload(); return true;'>";
			$html .= "<font color='#E35F06'>Ouvrir</font></a>&nbsp;&nbsp;";
		}
		$html .= "<a href='' onclick='window.location.reload(); return true;'>";
		$html .= "<font color='#131313'>Fermer</font>";
	...
	public function generer_recepisse_depot_particulier(){
		...
		if($oid!=0) {
			...
			$pdf->Output('./rapports/particuliers/recepisse_depot_famille_'.$famille->getAttr('nom_famille').'.pdf','F');
		}
		$html = "";	
		$html .= "<div style='width:200; overflow:auto;'>";
		$html .= "<h3>Resultat</h3><br/>";		
		...
		if ($dossier!=null){
			$html .= "<a href='/ScolBoursePHP/rapports/particuliers/recepisse_depot_famille_".$famille->getAttr('nom_famille').".pdf' target='_blank' onclick='window.location.reload(); return true;'>";
			$html .= "<font color='#E35F06'>Ouvrir</font></a>&nbsp;&nbsp;";
		}
		$html .= "<a href='' onclick='window.location.reload(); return true;'>";
		$html .= "<font color='#131313'>Fermer</font>";
